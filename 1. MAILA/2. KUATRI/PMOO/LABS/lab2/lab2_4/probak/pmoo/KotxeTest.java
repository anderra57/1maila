...
public class KotxeTest {
	...
	Kotxe pFiat2018, pRenault2019, pDacia2020, pMini2021;
	...
	public void setUp() throws Exception {
		...
		pAusBBp= new Pertsona(2, "Casey Stoner", 40, "B+", "Australia");
			 ...
			 */	
		pFiat2018=new Kotxe("2018", "Fiat");
		pRenault2019=new Kotxe("2019", "Renault");
		pDacia2020=new Kotxe("2020", "Dacia");
		pMini2021=new Kotxe("2021", "Mini");
	}
	//atributuak
