...
package ada_main is
   ...
   GNAT_Version : constant String :=
                    "GNAT Version: 8.2.1 20181127" & ASCII.NUL;
   pragma Export (C, GNAT_Version, "__gnat_version");

   Ada_Main_Program_Name : constant String := "_ada_proba_bataz_bestekoa" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#3ea0ef8b#;
   pragma Export (C, u00001, "proba_bataz_bestekoaB");
   ...
   u00074 : constant Version_32 := 16#66f8a801#;
   ...
   u00129 : constant Version_32 := 16#b81c9b15#;
   ...
   u00133 : constant Version_32 := 16#7812b349#;
   pragma Export (C, u00133, "bataz_bestekoaB");
   u00134 : constant Version_32 := 16#3c685009#;
   pragma Export (C, u00134, "datuakS");
   u00135 : constant Version_32 := 16#06352328#;
   pragma Export (C, u00135, "idatziB");
   ...
   u00140 : constant Version_32 := 16#b10ba0c7#;
   pragma Export (C, u00140, "system__img_biuB");
   u00141 : constant Version_32 := 16#b49118ca#;
   pragma Export (C, u00141, "system__img_biuS");
   u00142 : constant Version_32 := 16#4e06ab0c#;
   pragma Export (C, u00142, "system__img_llbB");
   u00143 : constant Version_32 := 16#f5560834#;
   pragma Export (C, u00143, "system__img_llbS");
   u00144 : constant Version_32 := 16#9dca6636#;
   pragma Export (C, u00144, "system__img_lliB");
   u00145 : constant Version_32 := 16#577ab9d5#;
   pragma Export (C, u00145, "system__img_lliS");
   u00146 : constant Version_32 := 16#a756d097#;
   pragma Export (C, u00146, "system__img_llwB");
   u00147 : constant Version_32 := 16#5c3a2ba2#;
   pragma Export (C, u00147, "system__img_llwS");
   u00148 : constant Version_32 := 16#eb55dfbb#;
   pragma Export (C, u00148, "system__img_wiuB");
   u00149 : constant Version_32 := 16#dad09f58#;
   pragma Export (C, u00149, "system__img_wiuS");
   u00150 : constant Version_32 := 16#d763507a#;
   pragma Export (C, u00150, "system__val_intB");
   u00151 : constant Version_32 := 16#0e90c63b#;
   pragma Export (C, u00151, "system__val_intS");
   u00152 : constant Version_32 := 16#1d9142a4#;
   pragma Export (C, u00152, "system__val_unsB");
   u00153 : constant Version_32 := 16#621b7dbc#;
   pragma Export (C, u00153, "system__val_unsS");
   u00154 : constant Version_32 := 16#239ea924#;
   pragma Export (C, u00154, "sortu_zerrenda_hutsaB");
   u00155 : constant Version_32 := 16#88f66c24#;
   pragma Export (C, u00155, "txertatu_hasieranB");
   u00156 : constant Version_32 := 16#935938d8#;
   pragma Export (C, u00156, "system__memoryB");
   u00157 : constant Version_32 := 16#1f488a30#;
   ...
   --  bataz_bestekoa%b
   --  idatzi%b
   --  sortu_zerrenda_hutsa%b
   --  txertatu_hasieran%b
   --  proba_bataz_bestekoa%b
