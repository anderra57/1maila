...
begin
   ...
   zer1:=txertatu_posizioan(zen,pos,Zerrenda1);
   ...
   Zerrenda1.Zenbakiak(1) := 3; Zerrenda1.Zenbakiak(2) := 1; Zerrenda1.Zenbakiak(3) := 4;
   Zerrenda1.Zenbakiak(4) := 5; Zerrenda1.Zenbakiak(5) := 5; Zerrenda1.Zenbakiak(6) := 8; Zerrenda1.Zenbakiak(7) := 6;
   Zerrenda1.Kont := 7;
   pos:=4;
   zen:=2;
   put_line("5. kasua: hainbat elementuko zerrendari erdian gehitu 2: (3 1 4 5 5 8 6)");
   put_line(" hasierako zerrenda: ");
   zerrenda_idatzi(Zerrenda1);
   put_line(" 2 erdian txertatzean emaitza honako izan beharko luke 3 1 4 2 5 5 8 6 eta bukaerako zerrenda honakoa da: ");
   zer1:=txertatu_posizioan(zen,pos,Zerrenda1);
   zerrenda_idatzi(zer1);
   new_line(3);
   put_line("Return teklari eman jarraitzeko");
