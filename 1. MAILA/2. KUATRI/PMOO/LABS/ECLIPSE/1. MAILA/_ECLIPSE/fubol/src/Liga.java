...
public class Liga
{
    ...
    public Liga(int numEquipos)
    {
        ...
        {
        	String nombre = crearEquipo(i+1);
        	Equipo equipo = new Equipo(nombre, 22);
    ...
    private String crearEquipo(int pNum){
    	System.out.println("Inserta el nombre del equipo " + pNum);
    	String nombre=Teklatua.getNireTeklatua().irakurriString();
    	String nombre2=String.format("%-14s", nombre);
    	return nombre2;
    }
}
