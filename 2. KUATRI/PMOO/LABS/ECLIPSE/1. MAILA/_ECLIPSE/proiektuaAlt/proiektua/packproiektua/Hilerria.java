...
public class Hilerria extends Egoera{
	...
	public void eszenatokiaHasieratu() throws FileNotFoundException, IOException{
		this.matrizea=FitxeroakIrakurri.mapaIrakurri("./fitxategiak/Hilerria/Hilerria.txt");
		this.pertsonaiakHasieratu();
	}
	
	public void eszenatokiaBukatu() throws FileNotFoundException, IOException{
		this.matrizea=FitxeroakIrakurri.mapaIrakurri("./fitxategiak/Hilerria/Hilerria_Bukatuta.txt");
		System.out.println();
		System.out.println();
		for (int i=0;i<20;i++) {
			  for (int j=0;j<20;j++) {
