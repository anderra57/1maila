...
public class Saloia extends Egoera{
	...
	public void eszenatokiaHasieratu() throws FileNotFoundException, IOException{
		this.matrizea=FitxeroakIrakurri.mapaIrakurri("./fitxategiak/Saloia/Saloia.txt");
		this.pertsonaiakHasieratu();
	}
	
	public void eszenatokiaBukatu() throws FileNotFoundException, IOException{
		this.matrizea=FitxeroakIrakurri.mapaIrakurri("./fitxategiak/Saloia/Saloia_Bukatuta.txt");
		System.out.println();
		System.out.println();
		for (int i=0;i<20;i++) {
			  for (int j=0;j<20;j++) {
    ...
    public void jokoaHasieratu() throws FileNotFoundException, IOException{
		this.hasieramatrizea=FitxeroakIrakurri.mapaIrakurri("./fitxategiak/Hasiera_mx.txt");
		System.out.println();
		System.out.println();
		for (int i=0;i<20;i++) {
			  for (int j=0;j<20;j++) {
		...
		FitxeroakIrakurri.fitxeroaErakutsi("./fitxategiak/aurkezpena.txt");
		Teklatua.getNireTeklatua().emanEnter();
    }
