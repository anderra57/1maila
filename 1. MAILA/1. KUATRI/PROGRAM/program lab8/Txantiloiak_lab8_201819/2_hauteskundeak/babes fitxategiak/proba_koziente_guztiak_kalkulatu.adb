...
with koziente_guztiak_kalkulatu;


procedure proba_koziente_guztiak_kalkulatu is
...
begin
   ...
   Skip_Line;
   --2. kasua:
   --- L_P_V_originala aldagaia aldatuko dugu 5 alderdi egon daitezen
    L_P_V_Originala.Alderdi_kop:=5;
    L_P_V_originala.Alderdien_taula(1) := ("       alderdi1", 130141);
    L_P_V_Originala.Alderdien_taula(2) := ("       alderdi2", 128103);
    L_P_V_originala.Alderdien_taula(3) := ("       alderdi3", 100241);
    L_P_V_originala.Alderdien_taula(4) := ("       alderdi4", 100050);
    L_P_V_Originala.Alderdien_taula(5) := ("       alderdi5",  90200);
...
end proba_koziente_guztiak_kalkulatu;
